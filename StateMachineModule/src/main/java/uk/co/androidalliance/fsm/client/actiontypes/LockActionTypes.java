...
public class LockActionTypes implements ActionType{

    public static final String ACTION_TYPE = LockActionTypes.class.getSimpleName();

    private final Object payload;

    public LockActionTypes (Object payload) {

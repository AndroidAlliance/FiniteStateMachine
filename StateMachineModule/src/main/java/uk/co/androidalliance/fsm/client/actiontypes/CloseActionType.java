...
public class CloseActionType implements ActionType {

    public static final String ACTION_TYPE = CloseActionType.class.getSimpleName();

    private final Object payload;

    public CloseActionType (Object payload) {

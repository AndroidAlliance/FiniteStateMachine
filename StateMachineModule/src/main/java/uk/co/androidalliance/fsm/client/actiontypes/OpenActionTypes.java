...
public class OpenActionTypes implements ActionType{

    public static final String ACTION_TYPE = OpenActionTypes.class.getSimpleName();

    private final Object payload;

    public OpenActionTypes (Object payload) {
